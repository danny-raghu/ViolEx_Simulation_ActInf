...
load('stationary_sequence.mat') %For Sim 1
load('nonstationary_sequence.mat') % For Sim 2, 3 and 4.
...
%%
if Sim ==1 %run this section only for Sim=1 using run and advance
...
elseif Sim == 2 %run this section even for sim = 3,4!
